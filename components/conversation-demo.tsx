...
export const ConversationDemo = () => {
  ...
  const { messages, sendMessage, status, regenerate }: any = useChat();
  ...
  return (
    <div className="flex flex-col h-[600px] border border-stone-200 dark:border-stone-800 rounded-xl overflow-hidden bg-white dark:bg-stone-900 shadow-xl">
        ...
        <PromptInput onSubmit={handleSubmit} className="p-4 border-t border-stone-100 dark:border-stone-800" globalDrop multiple>
          <PromptInputHeader>
