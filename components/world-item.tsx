...
import { PlanetDialog } from "./pixel-planet/planet-dialog";
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              <button
                ...
                className="h-16 w-16 overflow-hidden rounded-full bg-black/10 dark:bg-black/30 flex items-center justify-center relative hover:scale-110 transition-transform cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-900"
                title="View Planet"
              >
